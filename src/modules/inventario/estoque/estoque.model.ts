export default class EstoqueModel {
  ...
  static deRequisicao(body: any = {}) { return new EstoqueModel({ id: body.id || null, name: body.name, code: body.code, description: body.description, quantity: body.quantity, purchasePrice: body.purchasePrice, salePrice: body.salePrice }); }
