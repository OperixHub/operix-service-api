export default class OrdemServicoModel {
  ...
  static deRequisicao(body: any = {}) { return new OrdemServicoModel({ cod_order: body.cod_order || null, tenant_id: body.tenant_id || null, estimate: body.estimate, value: body.value, created_at: body.created_at || null }); }
  static deParametrosRequisicao(params: any = {}) { return new OrdemServicoModel({ cod_order: params.cod || params.cod_order }); }
